const content = {
  pageType: "jh-page", pageId: "classListSinglePage", table: "class", pageName: "班级管理高级", template: "jhTemplateV4", version: 'v2',
  resourceList: [
    {
  ...
  pageContent: [
    {
      ...
      rowActionList: [
        // 简写支持 pc 和 移动端折叠
        { text: '学生列表', icon: 'mdi-note-edit-outline', color: 'success', click: 'updateDrawerTab = 1; doUiAction("startUpdateItem", item)' },
  ...
  actionContent: [
    ...
    },
    {
      ...
      contentList: [
        ...
        { label: "学生列表", type: "component", componentPath: "studentList", attrs: { ":classId": "updateItem.classId", class: "px-4" } }
      ]
    }
  ],
  includeList: [
