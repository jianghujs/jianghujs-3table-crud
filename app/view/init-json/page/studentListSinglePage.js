const content = {
  pageType: "jh-page", pageId: "studentListSinglePage", table: "student", pageName: "学生列表高级", template: "jhTemplateV4", version: 'v2',
  resourceList: [
    {
  ...
  pageContent: [
    {
      ...
      rowActionList: [
        // 简写支持 pc 和 移动端折叠
        { text: '班级管理', icon: 'mdi-note-edit-outline', color: 'success', click: 'updateDrawerTab = 1; doUiAction("startUpdateItem", item)' },
  ...
  actionContent: [
    ...
    },
    {
      ...
      contentList: [
        ...
        { label: "班级管理", type: "component", componentPath: "classList", attrs: { ":studentId": "updateItem.studentId", class: "px-4" } }
      ]
    }
  ],
  includeList: [
