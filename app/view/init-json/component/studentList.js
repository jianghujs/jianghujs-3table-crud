const content = {
  pageType: "jh-component", pageId: "classListSinglePage", table: "student", pageName: "班级管理", template: "jhTemplateV4", version: 'v2', componentPath: 'studentList',
  resourceList: [
    {
  ...
  pageContent: [
    {
      ...
      headActionList: [
        { tag: 'v-btn', value: '分配学生列表', attrs: { color: 'success', class: 'mr-2', '@click': 'doUiAction("viewAllot")' }, quickAttrs: ['small'] },
        { tag: 'v-spacer' },
        /*html*/`
